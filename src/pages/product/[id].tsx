            ...
            <section>
                <div className="container">
                    <div id="reviews" className="review-section">
                        <div className="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <select
                                className="custom-select custom-select-sm border-0 shadow-sm ml-2 select2-hidden-accessible"
                ...
                <span className="selection">
                    <span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true"
                        ...
                        <span className="select2-selection__rendered" id="select2-qd66-container" role="textbox"
                              aria-readonly="true" title="Most Relevant">Most Relevant</span>
                        <span className="select2-selection__arrow" role="presentation"><b
                ...
                <span className="dropdown-wrapper" aria-hidden="true"></span>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <span>
                                    <button
                                        className="fit-button fit-button-color-blue fit-button-fill-ghost fit-button-size-medium stars-filter">5 Stars</button>
                                </span>
                                        </td>
                                ...
                                <div className="ranking">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            className="review-star rate-10 show-one"></span></span>
                                        </li>
                                        <li>
                                    ...
                                    <span>
                                        <img className="country-flag img-fluid"
                                             src="https://bootdey.com/img/Content/avatar/avatar3.png"/>
                                                ...
                                                <span
                                                    className="publish py-3 d-inline-block w-100">Published 4 weeks ago</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
